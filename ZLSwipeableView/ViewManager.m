...
@property (strong, nonatomic) UIDynamicItemBehavior *anchorViewDynamicItemBehavior;
...
- (void)dealloc {
  ...
  if (_anchorViewDynamicItemBehavior) {
    [_animator removeBehavior:_anchorViewDynamicItemBehavior];
  }
  if (_pushBehavior) {
...
- (void)attachView:(CGPoint)point {
  ...
  _anchorViewDynamicItemBehavior = [[UIDynamicItemBehavior alloc] initWithItems:@[_view]];
  _anchorViewDynamicItemBehavior.angularResistance = 1000;
  _anchorViewDynamicItemBehavior.allowsRotation = NO;
  
  [self addBehavior:_viewToAnchorViewAttachmentBehavior];
  [self addBehavior:_anchorViewToPointAttachmentBehavior];
  [self addBehavior:_anchorViewDynamicItemBehavior];
}
...
- (void)detachView {
  ...
  [self removeBehavior:_anchorViewDynamicItemBehavior];
}
...
- (void)pushViewFromPoint:(CGPoint)point inDirection:(CGVector)direction {
  ...
  _pushBehavior.magnitude = 0.01f * viewSize.width * viewSize.height;
